...
const CurvedTabBar = forwardRef((props,ref) => {
  ...
  const inputRef = useRef(onNavigateToItem);

  const currentValue = useRef(new Value(0)).current;
            ...
            return (
              <Animated.View key={index} style={[styles.btnIconWrap, {
                ...
                <Animated.View style={[styles.icon, {
                  ...
                  backgroundColor: position === (index) ? "red" : tabColor,
                }]} >
                  {item}
                </Animated.View>
